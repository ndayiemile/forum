        ...
        <div class="container-fluid ">
            <div class="row " style="height: 100vh; ">
                <div class="col-sm-6 text-black ">
                    ...
                    <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5 ">
                        ...
                        <form style="width: 23rem;" action="login.php" method="post">
                            ...
                            <?php if(!$valid_password_and_username):?>
                            <p class="text-danger h6 text-center pb-3">password and username don't much</p>
                            <?php endif ?>
                            ...
                            <p>Don't have an account? <a href="sinup.php " class="link-info ">Register here</a></p>
                ...
                <div class="col-sm-6 p-0 d-none d-sm-block ">
                    <img src="../dipository/img/header_backgrounds/hand-bulb.jpg " alt="Login image " class="img-fluid " style="width: 100%;height: 100%; ">
                </div>
            </div>
        </div>
    </section>
