...
<head>
    ...
    <script type="text/javascript" src="postpagev1.js" defer></script>
</head>
        ...
        <section class="row">
            ...
            <section class="col-md-8 p-0 pr-md-2">
                ...
                <?php foreach ($comments as $key => $value) : ?>
                    <!-- comment -->
                    <div class="bg-white shadow rounded border-left my-2 p-2 border-primary comment-box">
                        <!-- comment header -->
                        <div class="d-flex justify-content-between">
                            <div>
                        ...
                        <button class="btn btn-sm btn-outline-primary comment_response_form_triggler_button">respond</button>
                        </div>
                        <form action="" responseFormId ="<?php echo $value[4];?>" class="d-none form-group" method="post">
