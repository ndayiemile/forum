...
<head>
    ...
    <link rel="stylesheet" href="../libs/css/user_sinup.css">
    <script src="../libs/js/sinup.js" defer></script>
                    ...
                    <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
                        ...
                        <form style="width: 23rem;" action="authentication.php" method="post">
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <div id="username_status" class="username_status m-0"></div>
                                </div>
                            ...
                            <div class="pt-1 mb-4">
                                <button class="btn btn-info btn-lg btn-block" id="sinup" name="sinup" type="submit">Sin up</button>
                            </div>
